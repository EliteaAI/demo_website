export default function PricingSection() {
  ...
  const pricingCards = [
    ...
    },
    {
      ...
      features: [
        'APEXLOOP™ bedside unit',
        '60GHz radar sensor',
        'WiFi 6 + Bluetooth',
        '3-day battery backup',
        'Free app subscription included (3 months)',
      ],
      cta: 'Join Hardware Waitlist →',
      ctaAction: scrollToWaitlist,
      ctaStyle: 'hardware',
    ...
    <section id="pricing" aria-labelledby="pricing-heading" className="bg-brand-dark py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-400 text-sm">
          Hardware available Q3 2025. App available now.
        </p>
      </div>
    </section>
  );
